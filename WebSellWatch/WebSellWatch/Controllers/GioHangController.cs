...
namespace WebSellWatch.Controllers
{
    public class GioHangController : Controller
    {
        ...
        public ActionResult ThemGioHang(int masp, string URL)
        {
            ...
            //kiểm tra sự tồn tại của đồng hồ
            ...
            //kiểm tra tồn  tại màu sắc và size của đồng hồ
        ...
        {
            MailAddress fromAddress = new MailAddress("strorebeemo@gmail.com", "Beemo Store");
            MailAddress toAddress = new MailAddress(toEmail);
            const string fromPassword = "uldmutvyaarzqefk";
